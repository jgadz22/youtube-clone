        ...
        <div id="TopNav" class="w-[100%] h-[60px] fixed bg-black z-20 flex items-center justify-between">
            <div class="flex items-center">
                ...
                <Link :href="route('home')" class="flex text-white items-center justify-center mr-10 cursor-pointer">
                    ...
                    <img width="64" src="/images/YT-logo-text.png" alt="">
                </Link>
            </div>
            ...
            <div>
                <img 
                    ...
                    width="35"
                    src="https://yt3.ggpht.com/yti/AHXOFjWsyXTxpxfUhgbvnFouU8odIpdNy6BflZagIYFfLw=s88-c-k-c0x00ffffff-no-rj-mo" 
                >
            </div>
        </div>
